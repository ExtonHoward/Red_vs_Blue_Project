...
![ALT](/screenshots\rt_NMAP.JPG "nmap scan")
...
![ALT](/screenshots\rt_webserver.JPG "Web Server")
![ALT](/screenshots\rt_secret_folder.JPG "Secret Folder Login")
...
![ALT](/screenshots\rt_Hydra.JPG "Ashton's login credentials")
...
![ALT](/screenshots\rt_secret_file.JPG "connect-to_corp_server")
![ALt](/screenshots\rt-hash-id.JPG/ "Hash-Identifier")
![ALT](/screenshots\rt-crakstation.JPG "crackstation.net")
...
![ALT](/screenshots\rt_webdav_connection.JPG "WebDAV directory")
![ALT](/screenshots\rt_msfvenom_payload_reverse_shell.JPG "MSFVenom Payload)

Uploaded the payload, deployed a listener in Metasploit, then detonated the payload. Gained a Meterpreter session

![ALT](/screenshots\rt_meterpreter_session.JPG "Meterpreter session")

Dropped into a full shell, located the target file, and read out the flag.

![ALT](/screenshots\rt_shell.JPG "Shell")
![ALT](/screenshots\rt_Flag.JPG "Flag")
...
![ALT](/screenshots\bt_nmap_scan.JPG "nmap scan")
...
![ALT](/screenshots\bt_secret_folder_access1.JPG "Access of Secret Folder")
![ALT](/screenshots\bt_secret_folder_access2.JPG "Access of Secret Folder")
![ALt](/screenshots\bt_hydra.JPG "Brute Force Attack")
...
![ALT](/screenshots\bt_webdav_visulation.JPG "WebDAV access")
![ALT](/screenshots\bt_webdav_files.jpg "WebDAV files")
...
![ALT](/screenshots\bt_Meterpreter_connection1.JPG "TCP shell connection")
![ALT](/screenshots\bt_Meterpreter_connection2.JPG "TCP shell connection")
![ALT](/screenshots\bt_Meterpreter_traffic.JPG "Meterpreter traffic")
